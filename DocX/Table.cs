    ...
    public class Row
    {
        ...
        public void MergeCells(int startIndex, int endIndex)
        {
            ...
            foreach (Cell c in cells.Where((z, i) => i > startIndex && i <= endIndex))
            {
                ...
                // COMMENTED THIS LINE OUT BECAUSE IT WAS ADDING ANOTHER PARAGRAPH TO THE CELL,
                // WHICH I THEN HAD NO WAY TO REMOVE OUT OF THE CELL, SO THE CELL WOULD
                // END UP BEING TALLER THAN IT NEEDED TO BE. -jkruger 9/14/09
